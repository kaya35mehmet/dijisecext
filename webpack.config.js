...
const urlDev = "https://localhost:953/";
const urlProd = "https://e-stamp.dijisec.com/"; // CHANGE THIS TO YOUR PRODUCTION DEPLOYMENT LOCATION
...
module.exports = async (env, options) => {
  ...
  const config = {
    ...
    plugins: [
      ...
      new HtmlWebpackPlugin({
        filename: "stamp.html",
        template: "./src/taskpane/stamp.html",
        chunks: ["polyfill", "stamp"],
      }),
    ...
    devServer: {
      ...
      port: process.env.npm_package_config_dev_server_port || 953,
    },
  };
